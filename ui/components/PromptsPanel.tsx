...
const PROMPTS = [
  {
    category: "HEALTH", icon: "◈", color: "#10b981",
    items: [
  ...
  {
    category: "PROCESSES", icon: "⬡", color: "#6366f1",
    items: [
  ...
  {
    category: "CRONS", icon: "◷", color: "#f59e0b",
    items: [
  ...
  {
    category: "ALERTS", icon: "◉", color: "#ef4444",
    items: [
  ...
  {
    category: "NOTIFICATIONS", icon: "◎", color: "#06b6d4",
    items: [
  ...
  {
    category: "LOGS", icon: "≡", color: "#8b5cf6",
    items: [
...
export default function PromptsPanel({ onSelect }: Props) {
  return (
    <div style={{
      ...
      <div style={{
        padding: "14px 16px 10px", borderBottom: "1px solid rgba(255,255,255,0.05)",
        position: "sticky", top: 0, background: "rgba(6,6,10,0.98)",
