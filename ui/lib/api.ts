...
export interface AskResponse { answer: string; severity: string; thread_id: string; server: string }
export interface StatusResponse {
  overall: string; critical_count: number; warn_count: number; info_count: number
  total_events: number; period_mins: number; last_sweep_at: string|null
  last_sweep_status: string|null; servers: string[]; database: string
}
export interface Message { id: string; role: "user"|"agent"; content: string; severity?: string; ts: Date }
